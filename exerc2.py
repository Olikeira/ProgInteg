...
strings = ["banana", "maçã", "laranja", "uva"]
menor = menor_string(strings)
print("Menor string:", menor)

#13.Crie um algoritmo para ler um arquivo texto
caminho_do_arquivo = 'caminho/para/seu/arquivo.txt'
...
caminho_do_arquivo_csv = 'caminho/para/seu/arquivo.csv'

try:
    with open(caminho_do_arquivo_csv, 'r', encoding='utf-8') as arquivo_csv:
        leitor_csv = csv.reader(arquivo_csv)
        
        for linha in leitor_csv:
            print(linha)
except FileNotFoundError:
    print(f"O arquivo {caminho_do_arquivo_csv} não foi encontrado.")
except Exception as e:
...
caminho_do_arquivo_json = 'caminho/para/seu/arquivo.json'
...
try:
    ...
    print(f"O arquivo {caminho_do_arquivo_json} não foi encontrado.")
except json.JSONDecodeError:
    print(f"Erro ao decodificar o JSON do arquivo {caminho_do_arquivo_json}.")
except Exception as e:
